...
<head>
    ...
    <style>
        ...
        .logo-container {
            ...
            box-shadow: 0 8px 16px rgba(54, 179, 126, 0.2);
        }
        ...
        .form-control:focus {
            border-color: #36b37e;
            box-shadow: 0 0 0 0.25rem rgba(54, 179, 126, 0.15);
        }
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 6px 15px rgba(91, 147, 255, 0.3);
        }
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <p class="text-muted mb-0">Daftar untuk mulai menggunakan Kersa</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-4">
                                <label for="password_confirmation" class="form-label fw-medium text-dark">Konfirmasi Password</label>
                                <div class="input-group">
                                    <span class="input-group-text">
                                        <i class="fas fa-lock text-muted"></i>
                                    </span>
