    ...
    <div class="container">
       <div class="d-flex justify-content-between ">
        ...
        <div class="row g-4">
            ...
            <!-- Contact Info with Matching Style -->
            <div class="col-lg-5">
                <!-- Office Locations -->
                <div class="p-4 p-lg-4 rounded-4 mb-4" style="background-color: #ffffff; box-shadow: 0 10px 30px rgba(108, 99, 255, 0.08);">
                    ...
                    <div class="d-flex mb-4 align-items-start">
                        ...
                        <div>
                            <h6 class="fw-bold mb-1" >Kantor Cabang</h6>
                ...
                <div class="p-4 p-lg-4 rounded-4" style="background-color: #ffffff; box-shadow: 0 10px 30px rgba(108, 99, 255, 0.08);">
                    ...
                    <div class="d-flex flex-column gap-3">
                        <a href="#" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            ...
                            <span class="fw-medium" style="color: #424242;">Kersa.id</span>
                        </a>
                        <a href="#" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #eae7ff 0%, #f0f8ff 100%); width: 50px; height: 50px;">
                        ...
                        <a href="mailto:Kersa.id@gmail.com" class="d-flex align-items-center text-decoration-none p-3 rounded-3" style="transition: all 0.3s ease; ">
                            <div class="me-3">
                                <div class="rounded-circle d-flex align-items-center justify-content-center" style="background: linear-gradient(135deg, #eae7ff 0%, #f0f8ff 100%); width: 50px; height: 50px;">
                            ...
                            <span class="fw-medium" style="color: #424242;">Kersa.id@gmail.com</span>
                        </a>
                    </div>
                </div>
            </div>
